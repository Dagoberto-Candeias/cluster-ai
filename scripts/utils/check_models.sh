...
main() {
    ...
    if ! check_ollama_installed; then
        ...
        echo "curl --connect-timeout 30 --max-time 120 --connect-timeout 30 --max-time 120 --connect-timeout 30 --max-time 120 --connect-timeout 30 --max-time 120 --connect-timeout 30 --max-time 120 --connect-timeout 30 --max-time 120 -fsSL https://ollama.com/install.sh | sh"
