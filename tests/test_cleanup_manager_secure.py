...
class TestCleanupManagerSecure:
    ...
    def script_path(self):
        ...
        return Path(__file__).parent.parent / "scripts" / "management" / "cleanup_manager_secure.sh"
    ...
    def test_script_uses_common_library(self, script_path):
        ...
        with open(script_path, 'r') as f:
            content = f.read()
            assert 'source "${PROJECT_ROOT}/scripts/lib/common.sh"' in content, \
                "Script should source common.sh library"
