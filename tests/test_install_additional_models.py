...
class TestInstallAdditionalModels:
    ...
    def script_path(self):
        ...
        return Path(__file__).parent.parent / "scripts" / "ollama" / "install_additional_models.sh"
    ...
    def test_invalid_category(self, script_path):
        ...
        assert returncode == 1, f"Invalid category should return error code: {returncode}"
    ...
    def test_no_args_shows_help(self, script_path):
        ...
        assert "uso:" in stdout.lower() or "use:" in stdout.lower() or "categorias" in stdout.lower()
    ...
    def test_coding_category_structure(self, script_path):
        ...
        assert returncode in [0, 1], f"Unexpected return code for coding category: {returncode}"
    ...
    def test_creative_category_structure(self, script_path):
        ...
        assert returncode in [0, 1], f"Unexpected return code for creative category: {returncode}"
    ...
    def test_multilingual_category_structure(self, script_path):
        ...
        assert returncode in [0, 1], f"Unexpected return code for multilingual category: {returncode}"
    ...
    def test_science_category_structure(self, script_path):
        ...
        assert returncode in [0, 1], f"Unexpected return code for science category: {returncode}"
    ...
    def test_compact_category_structure(self, script_path):
        ...
        assert returncode in [0, 1], f"Unexpected return code for compact category: {returncode}"
