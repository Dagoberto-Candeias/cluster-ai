...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "monitoring: Testes relacionados ao monitoramento do sistema")
    config.addinivalue_line("markers", "alerts: Testes relacionados ao sistema de alertas")
    config.addinivalue_line("markers", "recovery: Testes relacionados à recuperação de falhas")
    config.addinivalue_line("markers", "timeout: Testes com configuração de timeout específica")
    ...
    config.addinivalue_line("markers", "input_validation: Testes de validação de entrada")
    config.addinivalue_line("markers", "command_injection: Testes de proteção contra injeção de comandos")
    ...
    config.addinivalue_line("markers", "data_transfer: Testes de transferência de dados")
    ...
    config.addinivalue_line("markers", "cache_performance: Testes de performance de cache")
