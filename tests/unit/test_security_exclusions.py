...
def test_excluded_directories_from_hardcoded_secrets_scan():
    ...
    exclude_dirs = [
        ...
        "venv", "env", "tests/reports", "logs", "backups",
        "certs_backup_", "reports", "performance", "monitoring",
        "ai-ml", "android", "backend", "backup", "compliance",
        "config", "deployments", "docs", "examples", "models",
        "scripts", "web-dashboard", "multi-cluster", "data",
        "certs", "tmp.", "build", "dist", ".vscode", ".github"
    ]
