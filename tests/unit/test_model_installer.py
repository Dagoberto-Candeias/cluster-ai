...
class TestModelInstaller:
    ...
    def test_color_variables_defined(self):
        ...
        with open(self.script_path, "r") as f:
            ...
            has_colors = any(color_var in content for color_var in ["RED=", "GREEN=", "YELLOW=", "GRAY="])
    ...
    def test_model_count_reasonable(self):
        ...
        with open(self.script_path, "r") as f:
            ...
            assert len(unique_models) >= 10, f"Encontrados apenas {len(unique_models)} modelos únicos, esperado pelo menos 10"
            ...
            for model in unique_models:
                ...
                assert abs(count - expected_duplicates_per_model) <= 1, f"Modelo {model} aparece {count} vezes, esperado ~{expected_duplicates_per_model}"
