...
class TestDemoRapida:
    ...
    def test_demo_rapida_success(self, mock_client_class, mock_cluster_class, mock_time):
        ...
        mock_client_instance.gather.return_value = [x**2 for x in range(1, 12)]  # 1 to 11 squared
        mock_client_class.return_value.__enter__.return_value = mock_client_instance
        mock_client_class.return_value.__exit__.return_value = None

        mock_time.time.side_effect = [0.0, 1.0, 2.0, 3.0]  # start, end parallel, start seq, end seq
...
class TestDemoMatrizes:
    ...
    @patch("simple_demo.LocalCluster")
    @patch("simple_demo.Client")
    def test_demo_matrizes_success(self, mock_client_class, mock_cluster_class, mock_random):
...
class TestDemoInterativa:
    ...
    @patch("simple_demo.LocalCluster")
    @patch("simple_demo.Client")
    def test_demo_interativa_choice_1(self, mock_client_class, mock_cluster_class, mock_da, mock_input):
    ...
    @patch("simple_demo.LocalCluster")
    @patch("simple_demo.Client")
    def test_demo_interativa_choice_2(self, mock_client_class, mock_cluster_class, mock_da, mock_input):
    ...
    @patch("simple_demo.LocalCluster")
    @patch("simple_demo.Client")
    def test_demo_interativa_choice_3(self, mock_client_class, mock_cluster_class, mock_input):
    ...
    @patch("simple_demo.LocalCluster")
    @patch("simple_demo.Client")
    def test_demo_interativa_invalid_choice(self, mock_client_class, mock_cluster_class, mock_input):
...
class TestMain:
    ...
    @patch("builtins.input")
    def test_main_success_with_interactive(self, mock_input, mock_banner, mock_rapida, mock_matrizes, mock_interativa):
    ...
    @patch("simple_demo.mostrar_banner")
    @patch("builtins.input")
    def test_main_success_without_interactive(self, mock_input, mock_banner, mock_rapida, mock_matrizes):
