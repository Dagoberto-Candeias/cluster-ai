...
class TestAndroidSetup:
    ...
    def setup_method(self):
        ...
        self.script_path = self.test_dir / "scripts" / "android" / "setup_android_worker.sh"
    ...
    def test_error_handling_enabled(self):
        ...
        with open(self.script_path, 'r') as f:
            content = f.read()
            assert 'set -euo pipefail' in content, "Script deve ter tratamento de erros habilitado"
...
class TestAutoDiscovery:
    ...
    def test_discovery_methods_defined(self):
        ...
        script_path = Path(__file__).parent.parent.parent / "scripts" / "android" / "setup_android_worker.sh"
