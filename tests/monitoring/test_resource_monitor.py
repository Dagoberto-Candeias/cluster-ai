...
class TestResourceMonitor(unittest.TestCase):
    ...
    def test_get_local_resources_success(self, mock_disk_usage, mock_virtual_memory, mock_cpu_percent):
        mock_cpu_percent.return_value = 50.5
        mock_virtual_memory.return_value = MagicMock(percent=60.5, total=8000, available=3000)
    ...
    def test_monitor_worker_resources_remote(self, mock_get_remote):
        mock_get_remote.return_value = {'cpu_usage': 10, 'worker_name': 'remote-worker', 'worker_type': 'remote'}
