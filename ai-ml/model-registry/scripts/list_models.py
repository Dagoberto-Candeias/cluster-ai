...
def list_models(args):
    ...
    print("=" * 80)
    print(f"{'Nome':<20} {'Versão':<10} {'Framework':<12} {'Tamanho':<10} {'Criado em':<20} {'Descrição':<50}")
    print("-" * 80)
    ...
    for model in models:
        ...
        print(f"{name:<20} {version:<10} {framework:<12} {size:<10} {created:<20} {description:<50}")
...
def main():
    ...
    parser.add_argument("--framework", choices=["pytorch", "tensorflow", "onnx"], help="Filtrar por framework")
